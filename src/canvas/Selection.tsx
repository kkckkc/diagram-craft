...
import { DragActions } from './drag.ts';
          ...
          <>
            ...
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(Point.fromEvent(e.nativeEvent), new RotateDragActions());
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  ...
                  new ResizeDragActions('resize-nw')
                );
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-ne')
                );
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-se')
                );
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-sw')
                );
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-n')
                );
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-e')
                );
                e.stopPropagation();
              }}
            />
            ...
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-s')
                );
                e.stopPropagation();
              }}
            />
            <circle
              ...
              onMouseDown={e => {
                ...
                props.onDragStart(
                  Point.fromEvent(e.nativeEvent),
                  new ResizeDragActions('resize-w')
                );
                e.stopPropagation();
              }}
            />
            ...
            <Fragment key={e.id}>
              <circle
                ...
                onMouseDown={ev => {
                  ...
                  props.onDragStart(
                    ...
                    new EdgeEndpointMoveActions(e, ev.currentTarget, 'start')
                  );
                  ev.stopPropagation();
                }}
              />
              <circle
                ...
                onMouseDown={ev => {
                  ...
                  props.onDragStart(
                    Point.fromEvent(ev.nativeEvent),
                    new EdgeEndpointMoveActions(e, ev.currentTarget, 'end')
                  );
                  ev.stopPropagation();
                }}
              />
...
type Props = {
  ...
  onDragStart: (coord: Point, actions: DragActions) => void;
};
